...
app.post('/api/debug-setup-lighting', async (req, res) => {
  try {
    const productsData = [
      // Headlights
      { id: "gid://shopify/Product/8939637047587", type: "Headlights", dept: "Lighting", tags: ["79-series"] },
      { id: "gid://shopify/Product/8939637309731", type: "Headlights", dept: "Lighting", tags: ["79-series"] },
      { id: "gid://shopify/Product/9759854264611", type: "Headlights", dept: "Lighting", tags: ["79-series"] },
      { id: "gid://shopify/Product/10223453995299", type: "Headlights", dept: "Lighting", tags: [] }, // 7 inch LED universal
      { id: "gid://shopify/Product/10223453667619", type: "Headlights", dept: "Lighting", tags: [] }, // 7 inch LED universal
      { id: "gid://shopify/Product/10289957830947", type: "Headlights", dept: "Lighting", tags: ["79-series"] },
      { id: "gid://shopify/Product/10289920672035", type: "Headlights", dept: "Lighting", tags: [] }, // 7 inch LED universal

      // Tail Lights
      { id: "gid://shopify/Product/8755175031075", type: "Tail Lights", dept: "Lighting", tags: ["75-series", "79-series"] },
      { id: "gid://shopify/Product/9759838273827", type: "Tail Lights", dept: "Lighting", tags: ["79-series"] },
      { id: "gid://shopify/Product/9765240897827", type: "Tail Lights", dept: "Lighting", tags: ["76-series"] },
      { id: "gid://shopify/Product/9765245550883", type: "Tail Lights", dept: "Lighting", tags: ["76-series"] },
      { id: "gid://shopify/Product/10087579353379", type: "Tail Lights", dept: "Lighting", tags: ["78-series"] },

      // Work Lights
      { id: "gid://shopify/Product/10289862246691", type: "Work Lights", dept: "Lighting", tags: [] },
      { id: "gid://shopify/Product/10297281708323", type: "Work Lights", dept: "Lighting", tags: [] }
    ];
    ...
    // 2. Create the 5 parent Category Collections
    const parentCollections = [
      { title: "Light Bars", type: "Light Bars" },
      { title: "Work Lights", type: "Work Lights" },
      { title: "Camp Lights", type: "Camp Lights" },
      { title: "Headlights", type: "Headlights" },
      { title: "Tail Lights", type: "Tail Lights" }
    ];

    for (const coll of parentCollections) {
      try {
        const colRes = await restClient.post({
          ...
          data: {
            smart_collection: {
              title: coll.title,
              rules: [{ column: "type", relation: "equals", condition: coll.type }],
              disjunctive: false
            }
          }
        });
    ...
    // 3. Create the 5 vehicle-specific sub-collections
    const subCollections = [
      { title: "79 Series Headlights", type: "Headlights", tag: "79-series" },
      { title: "79 Series Tail Lights", type: "Tail Lights", tag: "79-series" },
      { title: "76 Series Tail Lights", type: "Tail Lights", tag: "76-series" },
      { title: "78 Series Tail Lights", type: "Tail Lights", tag: "78-series" },
      { title: "75 Series Tail Lights", type: "Tail Lights", tag: "75-series" }
    ];
