...
app.post('/api/test-seo-update', async (req, res) => {
  try {
    ...
    console.log("🚀 Fetching 10 collections from Shopify...");
    ...
    for (const col of collections) {
      console.log(`\n✍️ Processing SEO for Collection: "${col.title}"`);
...
Requirements:
1. SEO Title: Must be between 50 and 60 characters long. It should be compelling, clean, containing keywords, and end with " | Track Auto".
2. Meta Description: Must be between 120 and 160 characters long. It should summarize the collection, highlight durability/quality, and include a natural Call to Action (CTA) like "Shop today!" or "Browse now!".
3. Return the output STRICTLY as a JSON object matching this structure:
{
...
Make sure the character counts are exactly within the limits.`;
      ...
      try {
        ...
        console.log(`✨ Generated SEO Title (${seoTitle.length} chars): "${seoTitle}"`);
        console.log(`✨ Generated SEO Desc (${seoDescription.length} chars): "${seoDescription}"`);
